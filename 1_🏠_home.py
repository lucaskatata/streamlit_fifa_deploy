...
if 'data' not in st.session_state:
    df_data = pd.read_csv(r'D:\Lucas\Estudos - Python\Asimov Academy\Criando Aplicativos Web com Streamlit\Projeto FIFA\datasets\CLEAN_FIFA23_official_data.csv', index_col=0)
